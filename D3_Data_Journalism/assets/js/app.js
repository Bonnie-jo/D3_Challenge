...
// Width and height based svg margins and parameters to fit chart grouping
var width = svgWidth - margin.left - margin.right;
var height = svgHeight - margin.top - margin.bottom;

// Append SVG group that contains the states data
...
function successHandle(statesData) {
  ...
  // Loop through data and pass argument data
  ...
  // Scale functions
  // Linear Scale takes min to be displayed in axis, and max of data
  ...
  // Axis functions per the scale functions
  ...
  // Bottom axis moves via height 
  chartGroup.append("g")
    .attr("transform", `translate(0, ${height})`)
    .call(bottomAxis);
  
  // Only append left axis 
  chartGroup.append("g")
    .call(leftAxis);
  ...
  // Event listeners to display and hide tooltip
  // ==============================
